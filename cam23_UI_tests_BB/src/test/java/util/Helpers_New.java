...
public abstract class Helpers_New {
  ...
  /**
   * Wait 15 seconds for locator to find an element *
   */
  ...
  /**
   * Wait 15 seconds for locator to find all elements *
   */
  ...
  /**
   * Wait 15 seconds for locator to not find a visible element *
   */
